...
class NetalyzrCLI implements NetalyzrShell{
   ...
   Properties config;
   String netaRoot = "YOUR-NODE-NAME.com";
   long startTime;
   ...
   NetalyzrCLI() {
      //generally this is false but we are leaving it on for now.
      this.neta.debugStdout = true;
   }
   ...
   public void init() {
      try {
         //was no question mark but we addded it because nbo python server as of yet:URL var1 = new URL("http://" + this.netaRoot + "/analysis/m=" + this.mode);
